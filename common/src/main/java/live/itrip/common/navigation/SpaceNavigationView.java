 ...
 */
package live.itrip.common.navigation;
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.nav_near_me);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.nav_near_me;
    ...
    private void addSpaceItems(LinearLayout leftContent, LinearLayout rightContent) {
        ...
        for (int i = 0; i < spaceItems.size(); i++) {
            ...
            RelativeLayout textAndIconContainer = (RelativeLayout) inflater.inflate(R.layout.space_nav_item_view, this, false);
