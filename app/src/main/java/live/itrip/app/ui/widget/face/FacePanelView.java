...
public class FacePanelView extends LinearLayout implements View.OnClickListener,
        FaceRecyclerView.OnFaceClickListener, SoftKeyboardUtils.IPanelHeightTarget {
    ...
    private void init() {
        mRealHeight = SoftKeyboardUtils.getMinPanelHeight(getResources());
        ...
        SoftKeyboardUtils.attach((Activity) getContext(), this);
    }
