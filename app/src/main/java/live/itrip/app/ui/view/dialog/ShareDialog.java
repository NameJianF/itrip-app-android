                ...
                OpenBuilder.with(mActivity)
                        ...
                        .share(share, new IUiListener() {
                            ...
                            public void onError(UiError uiError) {
                                ...
                                ToastUtils.showToast(getContext().getResources().getString(R.string.share_hint), Toast.LENGTH_SHORT, Gravity.NO_GRAVITY);
                            }
...
//                break;
    ...
    private ProgressDialog showWaitDialog(@StringRes int messageId) {
        if (mDialog == null) {
            mDialog = DialogUtils.getProgressDialog(mActivity);
        }
