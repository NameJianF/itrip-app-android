...
public class DeviceUtil {
    ...
    public static boolean isTablet() {
        int s = App.getContext().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(App.getContext().getPackageName());
    }
    ...
    public static void copyTextToBoard(String string) {
        ...
        clip.setText(string);
        ToastUtils.showToast(App.getContext().getResources().getString(R.string.copy_success));
    }
