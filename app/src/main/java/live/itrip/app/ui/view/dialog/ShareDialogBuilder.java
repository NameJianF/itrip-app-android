                ...
                OpenBuilder.with(mActivity)
                        ...
                        .share(share, new IUiListener() {
                            ...
                            public void onError(UiError uiError) {
                                hideWaitDialog();
                                String msg = getContext().getResources().getString(R.string.share_hint);
                                ToastUtils.showToast(msg, Toast.LENGTH_SHORT, Gravity.NO_GRAVITY);
                            }
...
//                break;
            ...
            case R.mipmap.ic_action_url:
                DeviceUtils.copyTextToBoard(share.getUrl());
                cancelLoading();
                break;
            //更多(调用系统分享)
            default:
    ...
    private ProgressDialog showWaitDialog(@StringRes int messageId) {
        if (mDialog == null) {
            mDialog = DialogUtils.getProgressDialog(mActivity, true);
        }
